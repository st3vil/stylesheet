...
Codes folded for simplest way to a fluid creativity landscape.

Gear for rapidly evolving experiments, inspiration chaser,
art machine. Incarnating surf aspects to web. Clean pieces.

A is a wave of awareness, bounding activity, draining/hoisting
many C for a J, the usual continual 4d unity of things in a
J, in a J, in a J...

C makes clean models of reality, stylehouse (and the
technology compiled into the wall it represents) makes those
worlds slide around.
...
See the tape.
    ...
    perl got Zu 4 b     # forks Goh and Goat and stylehouse.pl

stylehouse.pl is an editor, abandoned yet still used. careful not to click
buttons twice. listens to localhost:2000 or so.
hard wired paths and stuff. Relies on some linkage of house/shed:
    /h -> /home/s/stylehouse
    /s -> /home/s/styleshed
    /home/s/shed -> /home/s/styleshed # possibly

You could use anything else too. A mix will be clobbery.
Also in Zu is the tandem ghost percolation. Wakes up J (mo or pi)
by pin.
