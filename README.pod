...
=head2 DEPENDENCIES
    ...
    sudo apt-get install libyaml-syck-perl libjson-xs-perl libfile-slurp-perl libuuid-perl liblist-moreutils-perl
...
Dont edit w/way/*, it is included only so you can get up and running. Big
chicken/eggings going on all over the place. Hotwiring pin findable way
...
nails how its really supposed to be done.
...
Periodically do a ' Pintidy' at the repl to clean running processes/pin maps.
...
Instal lm-sensors and put a 'watch sensors' off in the corner somewhere...
...
Local/national food machine that won't suddenly all break/be slavery.
